...
<style lang="scss">
	...
	.social {
		...
		&-item {padding: 15px 0;}
		&-link {text-decoration: none; color: rgba(86, 99, 88, 255);}
	}
	...
	.content__main { display: flex; flex-wrap: wrap; padding: 60px;}
